...
class ManifoldGraphDataset(Dataset):
    def __init__(self, task, full_graphs, subgraph_k, degree_features, subsample_pctg=0.05, avoid_boundary=True, scale_features=False, edge_attrs="distance", lcp=True):
